...
Consider a system at which customers arrive and depart in single entities, such as customers in a shop or jobs at a machine.
...
\begin{exercise}[Continuation of~\cref{ex:111}] \clabel{ex:112} 
...
\begin{exercise}[Continuation of~\cref{ex:112}] \clabel{ex:113} 
...
\begin{exercise}[Continuation of~\cref{ex:113}] \clabel{ex:4}
Compute 
...
\begin{exercise}[Continuation of~\cref{ex:4}]\clabel{ex:l-110}
...
\begin{exercise}\clabel{ex:l-111}
...
\begin{exercise}\clabel{ex:l-112}
